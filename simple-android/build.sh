...
echo "=== 创建简单Android APK ==="

cd /workspace/projects
mkdir -p simple-android && cd simple-android

# 创建基本的Android项目结构
mkdir -p src/main/{java/com/simpletodo,res/{layout,values,mipmap-hdpi}}
...
# 创建MainActivity.java
cat > src/main/java/com/simpletodo/MainActivity.java << 'EOF'
package com.simpletodo;
...
<?xml version="1.0" encoding="utf-8"?>
<resources>
    <string name="app_name">Simple Todo</string>
</resources>
EOF

# 创建简单的build.xml (Ant构建)
cat > build.xml << 'EOF'
<?xml version="1.0" encoding="UTF-8"?>
<project name="SimpleTodo" default="help">
    <property name="target" value="android-21" />
    <property name="src" value="src" />
    
    <target name="help">
        <echo>Simple Todo Android App</echo>
        <echo>Use Android Studio or Eclipse to build this project</echo>
    </target>
</project>
EOF

echo "简单Android项目结构已创建"
echo "项目路径: /workspace/projects/simple-android"